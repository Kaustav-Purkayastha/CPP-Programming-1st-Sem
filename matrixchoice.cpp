...
/*Create matrix class using templates. Write a C++ program to perform the
following matrix operations(2D array implementation):
1. Sum, 2. Difference, 3. Product, 4. Transpose*/


template<class T>
class matrix
{
    T A[10][10], B[10][10], C[10][10], P[10][10]={0,0}, r1, c1, r2, c2, i, j, k, T1[10][10], T2[10][10];
public:
    void getdata();
    void display();
    void sum();
